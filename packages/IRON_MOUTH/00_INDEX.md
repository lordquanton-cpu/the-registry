# IRON MOUTH — Definitive Product Offering Package

**Classification:** Complete. Client-ready.  
**Version:** 1.0  
**Package Contents:** Confidentiality Enforcement
...
| **[03_SEAL_SPEC](./03_SEAL_SPEC.md)** | Flagship product — complete technical specification |
...
| Asset | Description |
|-------|-------------|
| `iron-mouth-hero.png` | Company banner |
| `seal-hero.png` | Flagship product hero |
...
**Name:** IRON MOUTH  
**Tagline:** *Some things are never said.*  
**Sector:** Confidentiality enforcement. Silence protocols. NDAs with teeth.
