# HARD COPY — Definitive Product Offering Package

**Classification:** Complete. Client-ready.  
**Version:** 1.0  
**Package Contents:** Physical Document Acquisition
...
| **[03_PULL_SPEC](./03_PULL_SPEC.md)** | Flagship product — complete technical specification |
...
| Asset | Description |
|-------|-------------|
| `hard-copy-hero.png` | Company banner |
| `pull-hero.png` | Flagship product hero |
...
**Name:** HARD COPY  
**Tagline:** *Paper exists. We retrieve it.*  
**Sector:** Physical document acquisition. Archive access. Paper trails.
