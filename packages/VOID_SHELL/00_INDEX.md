# VOID SHELL — Definitive Product Offering Package

**Classification:** Complete. Client-ready.  
**Version:** 1.0  
**Package Contents:** Asset Protection & Shell Structuring
...
| **[03_NEST_SPEC](./03_NEST_SPEC.md)** | Flagship product — complete technical specification |
...
| Asset | Description |
|-------|-------------|
| `void-shell-logo.png` | Primary mark |
| `void-shell-hero.png` | Company banner |
| `nest-hero.png` | Flagship product hero |
...
**Name:** VOID SHELL  
**Tagline:** *Your assets exist. Your name does not.*  
**Sector:** Asset protection. Shell structuring. Wealth obfuscation.
