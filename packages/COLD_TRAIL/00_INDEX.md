# COLD TRAIL — Definitive Product Offering Package

**Classification:** Complete. Client-ready.  
**Version:** 1.0  
**Package Contents:** Counter-Investigation & Case Collapse
...
| **[03_FREEZE_SPEC](./03_FREEZE_SPEC.md)** | Flagship product — complete technical specification |
...
| Asset | Description |
|-------|-------------|
| `cold-trail-hero.png` | Company banner |
| `freeze-hero.png` | Flagship product hero |
...
**Name:** COLD TRAIL  
**Tagline:** *Investigations that go nowhere.*  
**Sector:** Counter-investigation. Investigator neutralization. Case collapse.
